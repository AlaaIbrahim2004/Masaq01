    ...
    public class DataSeeding : IDataSeeding
    {
        ...
        public void DataSeed()
        {
            ...
            if (!_context.Courses.Any())
            {
                ...
                var level1 = _context.Levels.FirstOrDefault(l => l.LevelNumber == 1);
                ...
                var level2 = _context.Levels.FirstOrDefault(l => l.LevelNumber == 2);
                if (level2 is not null)
                {
                    ...
                    _context.Courses.Add(courseTerm1);
                    // إضافة الـ Courses إلى الـ Level (للعلاقة)
            ...
            if (!_context.Lessons.Any())
            {
                ...
                var course1 = _context.Courses.FirstOrDefault(c => c.Id == 1);
                ...
                var course2 = _context.Courses.FirstOrDefault(c => c.Id == 2);
                ...
                var course = _context.Courses.FirstOrDefault(l => l.Title.Contains("الترم الأول - تانية ثانوي"));
            ...
            if (!_context.Students.Any())
            {
                ...
                if (level1 is not null)
                {
                    ...
                    var level = _context.Levels.FirstOrDefault(l => l.LevelNumber == 2);
            ...
            var exam1 = _context.Exams.Include(e => e.questions).FirstOrDefault(e => e.Id == 1);
            ...
            var exam2 = _context.Exams.Include(e => e.questions).FirstOrDefault(e => e.Id == 2);
